...
public class KThread {
    ...
    /* save the alarm set for this thread */
    public KThread setAlarm(long alarm) {
    	this.alarm_time = alarm;
    	return this;
    }
    /* After calling waitUntil(), get the alarm associated with this thread */
    ...
    public void join() {
		...
		if(this.joined == false) {
            ...
            //this is newly created status variable only for interrupts
			boolean status = Machine.interrupt().disable();

            //status here refers to the current thread
            while(this.status != 4) {
